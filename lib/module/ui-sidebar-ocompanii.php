<div class="sidebar-btn-open nav-Nashiraboti scale-menu-btn-remove">
</div>
<div class='sidebar-con-dimmer toggle-blogbar'>
	<div class='blogbar-con-anim dropin-load darkmode-navsidebar-anim'>
		<div class="blogbar-tx1-title darkmode-navsidebar-title" style='-webkit-animation-duration: .4s;'>
			  <span>Developers О компании </span>
		</div>
				...
				<header id="masthead" class="site-header" role="banner">
					<div class="site-branding">
						<?php
							...
							<?php endif;
						?>
						<button class="secondary-toggle"><?php _e( 'Menu and widgets', 'по-Грузчик' ); ?></button>
					</div>
				</header>
				<?php get_sidebar(); ?>
			</div>
